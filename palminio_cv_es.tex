...
\usepackage{wrapfig} % used in figures
\usepackage[svgnames]{xcolor}            % Colors by their 'svgnames'
\usepackage{geometry}
	\textheight=700px                    % Saving trees ;-)
\usepackage{url}
\usepackage{hyperref}
\usepackage{placeins} % Command to control the position of floating images. Use by \FloatBarrier command.
...
\begin{wrapfigure}[5]{l}{0.25\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{tapa_libro_scrum_2}
\end{wrapfigure}
...
\item Capacitación de Equipos, Scrum Masters y Product Owners en Scrum, Kanban y Lean.
\end{itemize}
}
...
\CertificatesEntry{\large{\textbf{Leading SAFe, PMPO}}}{}
\CertificatesEntry{}{
...
\CoursesEntry{Power MBA}{2019}{Desarrollo Power MBA}{}
